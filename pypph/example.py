...
# H_1: pewne ścieżki o długości 1 pojawiły się dopiero przy filtrze 3 i 5, ale nigdy nie zostały wchłonięte (nie zniknęły)
...
# death = 10000.0 to cechy trwałe do końca filtracji
